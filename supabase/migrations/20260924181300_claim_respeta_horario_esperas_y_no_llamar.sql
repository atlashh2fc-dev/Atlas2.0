...
--   * Fuera de la franja de la campaña (dialer_campaign_in_calling_window) no
--     sale ninguna llamada nueva. Sin franja configurada, como siempre.
...
--     vuelo en cualquier campaña, llamada abierta o intento activo del lead.
...
begin
  ...
  -- Fuera de horario no se marca, aunque haya ejecutivos «Disponibles».
