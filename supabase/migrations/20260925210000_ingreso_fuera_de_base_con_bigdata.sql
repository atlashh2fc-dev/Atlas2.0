-- El ingreso fuera de base se completa con Bigdata.
--
-- Al escribir el RUT, la pantalla consulta Bigdata por el puente firmado y
-- propone razón social, contacto, teléfonos, correo, región, comuna,
-- dirección y rubro. Esta versión acepta además dirección, rubro y
-- completado_con ('bigdata'), para que la ficha diga de dónde salió el dato.
-- Todo lo demás es igual a 20260925200000_ingreso_fuera_de_base.sql.
