...
4. Un worker toma un intento mediante lease y token. Mercury recibe únicamente la transcripción de esa llamada, no la memoria previa. Devuelve hechos candidatos y citas literales; Atlas rechaza citas o referencias temporales inventadas.
