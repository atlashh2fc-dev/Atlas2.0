...
persiste el sobre y responde `202`; no actualiza leads en la solicitud.
...
HMAC-SHA256. Solo hace ACK de los `accepted_event_ids` cuando el receptor responde
`acknowledged: true`; una confirmación parcial reintenta lo no confirmado. Los destinos se
