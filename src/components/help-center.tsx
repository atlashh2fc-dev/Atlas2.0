...
const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    route: ["Configuración", "Contact center", "Campañas"],
  ...
  },
  {
    ...
    route: ["Configuración", "Contact center", "Flujos de gestión"],
  ...
  },
  {
    ...
    route: ["Configuración", "Contact center", "Cargas y listas"],
  ...
  },
  {
    ...
    route: ["Configuración", "Plataforma", "Usuarios y equipos"],
    ...
    steps: [
      ...
      { title: "Asigna la campaña", do: "Para agentes de discador, selecciona las campañas que puede operar. Atlas generará la extensión, elegirá la campaña activa y habilitará las colas vinculadas.", verify: "La campaña aparece en la fila del agente; no necesitas completar otro formulario técnico." },
    ],
  },
  {
    id: "phone",
    title: "Diagnosticar telefonía y estados",
    description: "Revisa la sincronización automática de anexos y las pausas operativas cuando exista una incidencia.",
    href: "/dashboard/admin/agentes-sip",
    action: "Revisar diagnóstico",
    icon: PhoneCall,
    roles: ["admin"],
    tags: ["sip", "extensión", "telefonía", "pausa", "estado agente"],
    route: ["Configuración", "Plataforma", "Telefonía · diagnóstico"],
    before: ["Comprueba primero que el agente tenga una campaña automática asignada.", "Usa esta pantalla solo si Atlas informa una falla de sincronización."],
    outcome: "Puedes distinguir una configuración automática sana de una incidencia real de telefonía.",
    screenTitle: "Diagnóstico de telefonía",
    screenControls: ["Estado de extensión", "Estado de sincronización", "Acciones de contingencia", "Estados de agente"],
    steps: [
      { title: "Revisa la sincronización", do: "Confirma que el agente tenga una extensión operativa en Asterisk. La extensión se crea automáticamente al asignar la campaña.", verify: "El agente aparece con estado Operativa en Asterisk." },
      { title: "Configura pausas", do: "Desde ⚙ Configuración > Contact center > Estados de agente define las razones de pausa disponibles y sus nombres operativos.", verify: "Los estados permiten distinguir motivos y no son etiquetas ambiguas." },
  ...
  },
  {
    ...
    route: ["Configuración", "Plataforma", "Integraciones", "Importar gestión"],
  ...
  {
    id: "manual-lead",
    title: "Ingresar un lead fuera de base",
    description: "Agrega a la campaña un cliente con RUT que no venía en la carga, con responsable correcto, sin esperar una carga masiva.",
    href: "/dashboard/leads/nuevo",
    action: "Ingresar fuera de base",
    icon: UserPlus,
    roles: ["supervisor", "admin"],
    tags: ["nuevo lead", "manual", "registro", "crear", "fuera de base", "rut"],
    route: ["Consola", "Registros", "Ingresar fuera de base"],
    ...
    screenTitle: "Ingresar fuera de base",
    screenControls: ["Campaña", "RUT", "Datos de contacto", "Equipo/ejecutivo", "Ingresar registro"],
    steps: [
